...
//		System.out.println("MinAmount in Settelementset:" + minAmount);
		this.withdrawl.setMinAmount(minAmount);
		this.minAmount = minAmount;
//		System.out.println(this.minAmount);
	}
	...
	public String toString() {
		return "Settlement [merCode=" + merCode + ", withdrawalWay=" + withdrawalWay + ", minAmount=" + minAmount
				...
				+ cityCode + ", zipCode=" + zipCode + ", otheramount=" + otheramount + ", bankphoneNumber="
				+ bankphoneNumber + ", bankCode=" + bankCode + ", bankName=" + bankName + ", bankBranch=" + bankBranch
				+ ", accountType=" + accountType + ", accountHolder=" + accountHolder + ", accountNumber="
				+ accountNumber + ", swiftCode=" + swiftCode + ", routingNumber=" + routingNumber + ", accountCurrency="
				+ accountCurrency + ", sortcode=" + sortcode + ", bank=" + bank + "]";
	}
